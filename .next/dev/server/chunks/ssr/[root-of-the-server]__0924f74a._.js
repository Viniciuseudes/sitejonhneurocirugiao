...
const metadata = {
    ...
    description: "Dr. John Rocha, neurocirurgião especializado em crânio, coluna e dor, com atuação em Recife, João Pessoa e Campina Grande. Cirurgia da coluna por vídeo, endoscopia e tratamento da dor.",
    generator: "v0.app",
    keywords: "neurocirurgião, cirurgia de coluna, endoscopia, neurocirurgia craniana, tratamento da dor, Recife, João Pessoa, Campina Grande",
    authors: [
        {
            name: "Dr. John Rocha"
        }
...
function RootLayout({ children }) {
    return(// <CHANGE> Added lang="pt-BR" for Portuguese content
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0924f74a._.js.map